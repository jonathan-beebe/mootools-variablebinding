Element.implement({
  ...
  makeBindable: function () {
     ...
     */
    this.bindVar = function(key, target, opt_c) {
     ...
     */
    this._isUserInputChange = function(elem, key) {
     ...
     */
    this.unbindVar = function(key, target, opt_c) {
     ...
     */
    this._notifyAll = function(key, value) {
    ...
    this._notify = function(item, key, value) {
